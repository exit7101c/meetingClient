...
import { getData, SS_VERSION, SS_BUILD, showAdPop } from "@/assets/js/common.js";
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "imsiTap",
        component: () => import("../views/page/ImsiTap.vue")
      },
      {
        path: "imsiTapCardDetail",
        component: () => import("../views/page/ImsiTapCardDetail.vue")
      },
      {
        path: "library",
      ...
      {
        path: "/feed",
        component: () => import("../views/page/CommunityFeed.vue")
      },
      {
        path: "mypage",
  ...
  },
  {
    ...
    component: () => import("../views/page/PartnersProfile.vue")
  },
  {
    path: "/sendLike",
    name: "SendLike",
  ...
  },
  {
    path: "/openChatMeet",
    name: "OpenChatMeet",
    component: () => import("../views/page/OpenChatMeet.vue"),
    props: true
  },
  {
    path: "/openChatMeetWrite",
    name: "OpenChatMeetWrite",
    component: () => import("../views/page/OpenChatMeetWrite.vue"),
    props: true
  },
  {
    path: "/openChatMeetView",
    name: "OpenChatMeetView",
    component: () => import("../views/page/OpenChatMeetView.vue"),
    props: true
  },
  {
    path: "/myOpenChatView",
  ...
  },
  {
    path: "/blockList",
    name: "BlockList",
    component: () => import("../views/page/BlockList.vue")
  },
  {
    path: "/certification",
    name: "Certification",
    component: () => import("../views/page/Certification.vue")
  },
  {
    path: "/certificationRegister",
    name: "CertificationRegister",
    component: () => import("../views/page/CertificationRegister.vue")
  },
  {
    path: "/certificationRegister_3",
    name: "CertificationRegister_3",
    component: () => import("../views/page/CertificationRegister_3.vue")
  },
  {
    path: "/certificationRegister_4",
    name: "CertificationRegister_4",
    component: () => import("../views/page/CertificationRegister_4.vue")
  },
  {
    path: "/certificationRegister_5",
    name: "CertificationRegister_5",
    component: () => import("../views/page/CertificationRegister_5.vue")
  },
  {
    path: "/certificationRegister_8",
    name: "CertificationRegister_8",
    component: () => import("../views/page/CertificationRegister_8.vue")
  },
  {
    path: "/certificationRegister_9",
    name: "CertificationRegister_9",
    component: () => import("../views/page/CertificationRegister_9.vue")
  },
  {
    path: "/certificationRegister_10",
    name: "CertificationRegister_10",
    component: () => import("../views/page/CertificationRegister_10.vue")
  },
  {
    path: "/myBadge",
    name: "MyBadge",
    component: () => import("../views/page/MyBadge.vue")
  }
];
...
router.beforeEach((to, from, next) => {
  let IS_LOCAL = process.env.NODE_ENV !== "production";
