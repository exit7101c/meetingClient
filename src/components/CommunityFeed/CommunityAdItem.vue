  ...
  <ion-card>
    <ion-item>
      ...
      <ion-label>
        ...
        <ion-icon slot="end" :src="iconAd" @click="openAdchoices"
                  style="float: right;padding: 8px 7px 2px;">
        </ion-icon>
      </ion-label>
...
import IconAd from "@/assets/img/icon/adchoices.svg";
