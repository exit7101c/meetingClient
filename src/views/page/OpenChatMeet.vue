          ...
          <ion-item-group>
            <ion-item>
              <ion-label>
                ...
                >
                  <ion-label>{{ talkUserCnt }} / {{ totalUserCount }}명</ion-label>
                </ion-text>
              </ion-label>
              <!--              <ion-icon-->
              <!--                slot="end"-->
  ...
  methods: {
    ...
    changeMeetMainValue() {
      ...
      if (this.openchatDelYn == "Y" && this.mainValue != "message") {
        this.warningAlert("이미 삭제 된 소모임입니다.");
        this.$router.go(-1);
      }
    ...
    joinIn(state) {
      ...
      if (this.choiceYn == "Y") {
          ...
          getData({
            ...
            then: (data) => {
              ...
              setTimeout(() => {
                ...
                if (state === "join") {
                  //메시지
                  this.warningAlert("참여 신청이 완료되었습니다.");
                }
        ...
        this.warningAlert("프로필이 완성되지 않았어요! 참여하려면 프로필설정을 완료해주세요. (필수사진등록)");
      }
