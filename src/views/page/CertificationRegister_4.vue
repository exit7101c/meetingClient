          ...
          <div class="mt-1">
            <h5 class="text-lg">
              ...
              >
                ...
                <ion-text color="secondary">연매출 5억원 이상 공식 서류</ion-text>
              </ion-row>
            </h5>
            <h5 class="text-lg">
              <ion-row
          ...
          <div class="mt-1">
            <div class="row-box">
              <table class="certification-table">
                <thead>
                <tr>
                  <th colspan="2">연매출 5억 이상 공식 서류</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                  <td colspan="2">
                    <ion-img :src="certification_img_4_1" />
                  </td>
                </tr>
                <tr>
                  <th>필수 노출</th>
                  <td>성함, 상호, 과세기간, 매출과세표준
                  </td>
                </tr>
                <tr>
                  <th>필수 제거</th>
            ...
            <div class="row-box">
              <table class="certification-table">
                ...
                <tr>
                  <td colspan="2">
                    <ion-img :src="certification_img_4_2" />
                  </td>
                </tr>
                <tr>
                  <th>필수 노출</th>
...
import certification_img_4_1 from "@/assets/img/certification/certification_img_4_1.png";
import certification_img_4_2 from "@/assets/img/certification/certification_img_4_2.png";

export default {
  name: "CertificationJobRegister_4",
  ...
  data() {
    return {
      certification_img_4_1,
      certification_img_4_2,
