          ...
          <div class="mt-2">
            <CardBox color="medium">
              <p>
                ...
                >1. 구독자 3만명 이상 유튜버<br />
                  2. 아프리카 TV,트위치,틱톡 등 방송플랫폼 유명 BJ
                </ion-text
                >
              </p>
            </CardBox>
          ...
          <div class="mt-1">
            <h5 class="text-lg">
              ...
              >
                ...
                <ion-text color="secondary">유튜브 3만 이상 구독자를 보유한 경우</ion-text>
              </ion-row>
            </h5>
            <CardBox color="medium">
              <p>
                ...
                >
                  ...
                  <ion-text color="secondary">3만 이상 표시된 채널 계정 캡쳐 화면</ion-text>
                </ion-row>
              </p>
              <p>
                <ion-row
                ...
                >
                  ...
                  <ion-text color="secondary">유튜브 스튜디오 대시보드 캡쳐 화면
                  </ion-text>
                </ion-row>
              </p>
            </CardBox>
          ...
          <div class="row-box">
            <h5 class="text-lg">
              ...
              >
                ...
                <ion-text color="secondary">그 외 방송플랫폼 유명 스트리머일 경우
                </ion-text>
              </ion-row>
            </h5>
            <CardBox color="medium">
              <p>
                <ion-text color="secondary">팔로워 및 구독자가 표시된 화면 캡쳐본</ion-text>
              </p>
            </CardBox>
          </div>
        </div>
        <div class="row-box">
          ...
          <div class="mt-1">
            <table class="certification-table">
              ...
              <tr>
                <td colspan="2">
                  <ion-img :src="certification_img_10_1" />
                </td>
              </tr>
              <tr>
                <th>필수 노출</th>
          ...
          <div class="mt-1">
            <table class="certification-table">
              <thead>
              <tr>
                <th colspan="2">유튜브 스튜디오 대시보드 캡쳐본
                </th>
              </tr>
              </thead>
              <tbody>
              <tr>
                <td colspan="2">
                  <ion-img :src="certification_img_10_2" />
                </td>
              </tr>
              <tr>
                <th>필수 노출</th>
...
import certification_img_10_1 from "@/assets/img/certification/certification_img_10_1.png";
import certification_img_10_2 from "@/assets/img/certification/certification_img_10_2.png";

export default {
  name: "CertificationJobRegister_10",
  ...
  data() {
    return {
      certification_img_10_1,
      certification_img_10_2,
