        ...
        <div class="row-box">
          ...
          <div class="mt-1">
            <h5 class="text-lg">
              ...
              >
                <ion-badge color="warning">필수1</ion-badge>
                <ion-text color="secondary"
                >5만 이상이 표시된 계정 캡쳐본
                </ion-text
                >
              ...
              <ion-row
                class="ion-align-items-center ion-justify-content-start gap-md flex-nowrap"
              >
                <ion-badge color="warning">필수2</ion-badge>
                <ion-text color="secondary"
                >인스타그램 계정내 본인을 확인할 수 있는 사진 보유
                </ion-text
                >
              </ion-row>
            </h5>
        ...
        <div class="row-box">
          ...
          <div class="mt-1">
            <table class="certification-table">
              ...
              <tr>
                <td colspan="2">
                  <ion-img :src="certification_img_9" />
                </td>
              </tr>
              <tr>
                <th>필수 노출</th>
...
import certification_img_9 from "@/assets/img/certification/certification_img_9.png";

export default {
  name: "CertificationJobRegister_9",
