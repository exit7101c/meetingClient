  ...
  <ion-header class="custom-header">
    <ion-toolbar mode="md">
      ...
      <ion-buttons slot="secondary">
        ...
        >
          <ion-icon :icon="personOutline" style="color: black" />
        </ion-button>
        <!--    상점 임시 주석      -->
        <ion-button
          v-if="
        ...
        <ion-button @click="checkedAlarm" class="has-chip">
          ...
          ></ion-icon>
          <ion-chip v-if="chkAlarm === false" class="chip-alarm">7</ion-chip>
        </ion-button>
      </ion-buttons>
    </ion-toolbar>
  </ion-header>
