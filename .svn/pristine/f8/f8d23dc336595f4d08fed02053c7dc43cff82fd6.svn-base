          ...
          <div class="mt-2">
            <CardBox color="medium">
              <p>
                ...
                >서울대 / 연세대 / 고려대 /카이스트 / 포항공대 / 아이비리그 (학부 졸업생, 재학생만 가능)
                </ion-text
                >
              </p>
            </CardBox>
        ...
        <div class="row-box">
          ...
          <div class="mt-1">
            <table class="certification-table">
              ...
              <tr>
                <td colspan="2">
                  <ion-img :src="certification_img_8" />
                </td>
              </tr>
              <tr>
                <th>필수 노출</th>
...
import certification_img_8 from "@/assets/img/certification/certification_img_8.png";


export default {
  name: "CertificationJobRegister_8",
