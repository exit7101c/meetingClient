<template>
  <ion-page>
    ...
    <ion-toolbar style="padding: 0 10px 0 10px" mode="md">
      ...
      <ion-title @click="modalOpen = true" style="padding: 0px;font-weight: 400;font-size: 18px;">{{ locationView }}
      </ion-title>
    ...
    <ion-content :fullscreen="true" ref="imsiTap">
      ...
      <ion-list lines="none">
        ...
        <ion-row style="margin-left:20px;margin-right:20px;">
          <ion-col size="4" v-for="(item, index) in albumList" :key="index" style="padding: 3px;">
            <ImsiTapAlbumItem
              :item="item"
              @event="goRouter(item)"
            />
    ...
    <ion-fab slot="fixed" vertical="bottom" horizontal="end">
      <ion-fab-button fill="clear" @click="scrollToTop2" style="padding: 5px">
...
export default {
  ...
  methods: {
    ...
    scrollToTop2() {
      this.$refs.imsiTap.$el.scrollToTop(250);
    },
