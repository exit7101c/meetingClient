          ...
          <div class="mt-2">
            <CardBox color="medium">
              <p>
                ...
                >의사 / 치과의사 / 한의사 / 판사 / 검사 / 변호사 / 5급 공무원 / 변리사 / 수의사 / 회계사 / 세무사 / 법무사 / 노무사 / 감평사 / 파일럿 / 약사 / /교수/
                  도선사 / 행정사 / 계리사 / 공증인 / 건축사
                  전문 자격증이 필요한 직종
                </ion-text
                >
        ...
        <div class="row-box">
          ...
          <div class="mt-1">
            <table class="certification-table">
              ...
              <tr>
                <td colspan="2">
                  <ion-img :src="certification_img_3" />
                </td>
              </tr>
              <tr>
                <th>필수 노출</th>
...
import certification_img_3 from "@/assets/img/certification/certification_img_3.png";

export default {
  name: "CertificationJobRegister_3",
