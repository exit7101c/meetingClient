<template>
  <ion-item lines="none" class="community-ion-item" @click="handleClick">
    ...
    <ion-label style="margin-left: 10px;">
      ...
      <ion-chip class="chip-sm chip-secondary" v-if="detail?.isRegYn !== 'Y' && detail.boardId != '7'"
                      @click="handleLetterBtn" style="padding: 2px; font-size: 12px; margin-left: 5px;">익명 메세지
      </ion-chip>
